...
{
    public class CustomBaseSignInWithAppleService : BaseSignInWithAppleService
        {
            private readonly KeychainSessionManager _sessionManager;

            public CustomBaseSignInWithAppleService(Func<UIWindow> windowProvider)
                : base(windowProvider)
            {
                // For the purpose of this demo app, store the userIdentifier in the keychain.
                _sessionManager = new KeychainSessionManager("com.xamarin.AddingTheSignInWithAppleFlowToYourApp");
            }
